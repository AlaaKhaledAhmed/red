class AppMessage {
  ...
  static String deleteData = "حذف بيانات";
  static String updateData = "تحديث بيانات";
  static String wait = "انتظر من فضلك";
  static String weekPassword = "كلمة المرور ضعيفة";
  static String emailFound = "البريد الالكتروني مستخدما مسبقا";
