                                ...
                                children: [
                                  TextSpan(
                                     style:
                                      ...
                                      text:
                                          '1- '+'الوقوف خلف الشخص المصاب لتحقيق التوازن' +
                                              "\n"),
                                  TextSpan(
                                    text:
                                         '2- '+'وضع إحدى القدمين أمام الاخري قليلا لتحقيق التوازن ' +
                                            "\n",
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                  TextSpan(
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                      text:
                                          '3- '+ 'لف الذراعين حول خصر الشخص المصاب ' +
                                              "\n"),
                                  TextSpan(
                                    text:
                                         '4- '+'إمالة الشخص المصاب إلى الامام قليلا' +
                                            "\n",
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                  TextSpan(
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                    text:
                                        '5- '+ 'عمل قبضة باليد األخرى ثم وضعها فوق منطقة السرة' +
                                            "\n",
                                  ),
                                  TextSpan(
                                    text:
                                        '6- '+ 'مسك القبضة باليد األخرى ثم توجيه ضغطة بقوة على البطن بسرعة نحو األعلى' +
                                            "\n",
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                  TextSpan(
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                    text:
                                         '7- '+'القيام بمعدل 6 إلى 10 ضغطات بطنية حتى يزول الجسم العالق' +
                                            "\n",
                                  ),
                                  TextSpan(
                                    text:
                                       '8- '+  'أما في حال كان الشخص المصاب قد فقد وعيه فقم باإلنعاش' +
                                            "\n",
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                    ...
                                    children: [
                                      TextSpan(
                                         style: TextStyle(
                                          ...
                                          text:
                                              '1- '+ 'استرخ على السرير وقم بإراحة عضالت الرقبة والكتفين' +
                                                  "\n"),
                                      TextSpan(
                                        text:
                                            '2- '+ 'قم بضم شفتيك جيدا وتنفس بعمق من األنف لمدة ثانيتين' +
                                                "\n",
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold),
                                      ),
                                      TextSpan(
                                         style: TextStyle(
                                            fontWeight: FontWeight.bold),
                                          text:
                                             '3- '+ 'قم بإخراج الهواء من شفتيك المضمومتين لمدة 4 ثواني' +
                                                  "\n"),
                                      TextSpan(
                                        text:
                                           '4- '+ 'ستمر على هذا التمرين لمدة عشر دقائق' +
                                                "\n",
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold),
                                      )
